...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('rdx');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Employee\Rdx\Model\Rdx')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('rdx/*/index');
    }
