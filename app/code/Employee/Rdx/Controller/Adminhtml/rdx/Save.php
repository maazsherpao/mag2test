...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            $model = $this->_objectManager->create('Employee\Rdx\Model\Rdx');
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('The Rdx has been saved.'));
                ...
                $this->messageManager->addException($e, __('Something went wrong while saving the Rdx.'));
            }
