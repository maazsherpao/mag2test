...
namespace EmployeModule\RdxSports\Block\Adminhtml\Employee\Edit\Tab;

/**
 * Employee edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /* @var $model \EmployeModule\RdxSports\Model\BlogPosts */
        $model = $this->_coreRegistry->registry('employee');
